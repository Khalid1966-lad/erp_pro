...
async function main() {
  ...
  const products = await Promise.all([
    // Raw materials
    db.product.create({ data: { reference: 'MP-001', designation: 'Tôle acier 2mm', description: 'Tôle d\'acier laminé à froid, épaisseur 2mm', priceHT: 45.00, tvaRate: 20, unit: 'kg', productType: 'raw_material', currentStock: 2500, minStock: 500, maxStock: 5000, averageCost: 42.50, isActive: true } }),
    db.product.create({ data: { reference: 'MP-002', designation: 'Aluminium 6061 barre 30mm', description: 'Barre cylindrique en alliage aluminium 6061', priceHT: 18.50, tvaRate: 20, unit: 'm', productType: 'raw_material', currentStock: 800, minStock: 200, maxStock: 2000, averageCost: 16.00, isActive: true } }),
    db.product.create({ data: { reference: 'MP-003', designation: 'Polycarbonate transparent 5mm', description: 'Plaque polycarbonate transparent, épaisseur 5mm', priceHT: 32.00, tvaRate: 20, unit: 'm²', productType: 'raw_material', currentStock: 150, minStock: 50, maxStock: 500, averageCost: 28.50, isActive: true } }),
    db.product.create({ data: { reference: 'MP-004', designation: 'Visserie M8 inox lot 100', description: 'Lot de 100 vis M8x40 en acier inox A2', priceHT: 12.80, tvaRate: 20, unit: 'lot', productType: 'raw_material', currentStock: 300, minStock: 100, maxStock: 1000, averageCost: 11.00, isActive: true } }),
    db.product.create({ data: { reference: 'MP-005', designation: 'Peinture époxy gris RAL 7001', description: 'Peinture époxy industrielle 2 composants', priceHT: 85.00, tvaRate: 20, unit: 'kg', productType: 'raw_material', currentStock: 80, minStock: 30, maxStock: 200, averageCost: 78.00, isActive: true } }),
    db.product.create({ data: { reference: 'MP-006', designation: 'Câble électrique 2.5mm²', description: 'Câble cuivre rigide, section 2.5mm²', priceHT: 3.50, tvaRate: 20, unit: 'm', productType: 'raw_material', currentStock: 5000, minStock: 1000, maxStock: 10000, averageCost: 3.20, isActive: true } }),
    db.product.create({ data: { reference: 'MP-007', designation: 'Joint torique NBR 50mm', description: 'Joint torique Nitrile, diamètre intérieur 50mm', priceHT: 2.40, tvaRate: 20, unit: 'pièce', productType: 'raw_material', currentStock: 0, minStock: 100, maxStock: 500, averageCost: 2.00, isActive: true } }),
    db.product.create({ data: { reference: 'MP-008', designation: 'Rondelle M10 inox lot 50', description: 'Lot de 50 rondelles M10 en acier inox', priceHT: 5.50, tvaRate: 20, unit: 'lot', productType: 'raw_material', currentStock: 50, minStock: 50, maxStock: 300, averageCost: 4.80, isActive: true } }),

    // Semi-finished products
    db.product.create({ data: { reference: 'SF-001', designation: 'Châssis soudé type A', description: 'Châssis en tôle acier soudé, dimensions 600x400mm', priceHT: 120.00, tvaRate: 20, unit: 'pièce', productType: 'semi_finished', currentStock: 25, minStock: 10, maxStock: 100, averageCost: 95.00, isActive: true } }),
    db.product.create({ data: { reference: 'SF-002', designation: 'Panneau aluminium usiné', description: 'Panneau en aluminium usiné CNC, dimensions 300x200mm', priceHT: 85.00, tvaRate: 20, unit: 'pièce', productType: 'semi_finished', currentStock: 15, minStock: 5, maxStock: 50, averageCost: 65.00, isActive: true } }),
    db.product.create({ data: { reference: 'SF-003', designation: 'Armoire électrique câblée', description: 'Armoire de distribution avec câblage basique', priceHT: 450.00, tvaRate: 20, unit: 'pièce', productType: 'semi_finished', currentStock: 8, minStock: 3, maxStock: 20, averageCost: 380.00, isActive: true } }),

    // Finished products
    db.product.create({ data: { reference: 'PF-001', designation: 'Armoire industrielle modulable', description: 'Armoire de rangement industriel 5 niveaux, capacité 500kg/niveau', priceHT: 850.00, tvaRate: 20, unit: 'pièce', productType: 'finished', currentStock: 12, minStock: 5, maxStock: 50, averageCost: 620.00, isActive: true } }),
    db.product.create({ data: { reference: 'PF-002', designation: 'Banc de travail technique', description: 'Banc de travail avec établi, éclairage LED et prises intégrées', priceHT: 1250.00, tvaRate: 20, unit: 'pièce', productType: 'finished', currentStock: 5, minStock: 3, maxStock: 20, averageCost: 980.00, isActive: true } }),
    db.product.create({ data: { reference: 'PF-003', designation: 'Tablette de protection polycarbonate', description: 'Tablette de protection transparente pour poste de travail', priceHT: 280.00, tvaRate: 20, unit: 'pièce', productType: 'finished', currentStock: 20, minStock: 10, maxStock: 100, averageCost: 195.00, isActive: true } }),
    db.product.create({ data: { reference: 'PF-004', designation: 'Étagère lourde charge 1000kg', description: 'Étagère métallique 5 niveaux, charge 1000kg/ niveau', priceHT: 680.00, tvaRate: 20, unit: 'pièce', productType: 'finished', currentStock: 8, minStock: 3, maxStock: 30, averageCost: 490.00, isActive: true } }),
    db.product.create({ data: { reference: 'PF-005', designation: 'Coffret électrique IP65', description: 'Coffret de distribution IP65, 12 modules', priceHT: 320.00, tvaRate: 20, unit: 'pièce', productType: 'finished', currentStock: 18, minStock: 5, maxStock: 60, averageCost: 230.00, isActive: true } }),
    db.product.create({ data: { reference: 'PF-006', designation: 'Chariot atelier 3 plateaux', description: 'Chariot de manutention atelier avec 3 plateaux', priceHT: 450.00, tvaRate: 20, unit: 'pièce', productType: 'finished', currentStock: 0, minStock: 5, maxStock: 25, averageCost: 340.00, isActive: true } }),
  ])
